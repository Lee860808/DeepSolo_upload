...
#---------------------------------------------------------------------------- #
# Post-Processing Options (e.g., for Language Model)
# ---------------------------------------------------------------------------- #
_C.MODEL.POST_PROCESS = CN()
_C.MODEL.POST_PROCESS.ENABLED = False # You can use this to easily toggle it
_C.MODEL.POST_PROCESS.LM_PATH = "/home/kylee/DeepSolo/character_lm.arpa"    # Path to the KenLM binary model
_C.MODEL.POST_PROCESS.LM_WEIGHT = 0.15 # Weight for the language model score
_C.MODEL.POST_PROCESS.BEAM_WIDTH = 10  # Beam width for beam search decoding
