...
if project_root in sys.path:
    sys.path.remove(project_root) # Remove if it exists elsewhere
sys.path.insert(0, project_root)   # Insert at the beginning

print(f"DEBUG: Modified sys.path. Project root '{project_root}' added to the beginning.")
print(f"DEBUG: Current sys.path[0]: {sys.path[0]}")
if len(sys.path) > 1:
    print(f"DEBUG: Current sys.path[1]: {sys.path[1]}")
